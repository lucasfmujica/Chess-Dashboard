...
/**
 * Chess-specific glyphs with no heroicons equivalent. Decorative, like the
 * heroicons they sit beside: the label is on the control, not the glyph.
 */

export const Swords = ({ className }: IconProps) => (
  <svg className={className} aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
