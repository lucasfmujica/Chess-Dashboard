    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700">
        ...
        <div className="p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Keep track of your scheduled competitions</p>
              </div>
            </div>
            <button
          ...
          {isAddingTournament && (
            <div className="mb-6 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700 rounded-xl border-2 border-blue-200 dark:border-slate-600">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  onClick={resetForm}
                  className="px-6 py-2.5 bg-gray-300 dark:bg-slate-600 text-gray-700 dark:text-gray-200 font-semibold rounded-lg hover:bg-gray-400 dark:hover:bg-slate-500 transition-colors"
                >
                  Cancel
                </button>
              </div>
          ...
          {upcomingTournaments.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-lg">No upcoming tournaments scheduled</p>
              <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">Click "Add Tournament" to schedule your next competition</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 gap-4">
              {upcomingTournaments.map(tournament => (
                <div
                  key={tournament.id}
                  className="p-5 bg-gradient-to-r from-white to-blue-50 dark:from-slate-800 dark:to-slate-700 rounded-xl border border-blue-200 dark:border-slate-600 hover:shadow-lg transition-shadow duration-200"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{tournament.name}</h4>
